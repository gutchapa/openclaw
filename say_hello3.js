...
// Use commas/periods so the TTS engine pauses between each phrase
const text = 'Hello Ladoo, Hello Ladoo, Hello Ladoo';
...
client.connect(host, () => {
  ...
  client.launch(DefaultMediaReceiver, (err, player) => {
    ...
    player.load(media, { autoplay: true }, (err, status) => {
      ...
      setTimeout(() => client.close(), 7000); // 7 seconds so it doesn't cut off early
    });
  });
});
